package ru.sbt.mipt.oop.reflection;
...
public class BeanUtils {
    ...
    private boolean isGetter(Method method) {
        return method.getName().substring(0, 3).equals("get") && Character.isUpperCase(method.getName().charAt(3)) &&
                method.getParameterCount() == 0;
    }

    private boolean isSetter(Method method) {
        return method.getName().substring(0, 3).equals("set") && Character.isUpperCase(method.getName().charAt(3)) &&
